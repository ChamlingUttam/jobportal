...
// import { getSavedApplication, saveApplication } from "./applicationLocalStorage";
...
//     const savedApplications = getSavedApplication()

//     if(savedApplications.length > 0){
//       return savedApplications
//     }

//    saveApplication(mockApplications) //move it to the localstorage
...
//   const applications = await getAllJobApplication()
...
//   const applications = await getAllJobApplication()
//     const jobApplied = applications.find((application)=>application.userId ===userId && application.jobId ===jobId)
...
//     applications.push(newJobApplication)
...
export const getAllJobApplication = async (): Promise<Application[]> => {
  ...
  saveApplication(mockApplications);
...
export const applyForJob = async (
  ...
  const jobApplied = applications.find(
    (application) =>
